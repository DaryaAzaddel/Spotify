...
public class controls2 {
    ...
    private Media m = new Media(getClass().getResource("/sounds/badblood.mp3").toString());
    ...
    private void initialize(){
        ...
        lplays.setText("Plays: "+Integer.toString(singer.getSongs().get(1).getPlays()) + " millions");
