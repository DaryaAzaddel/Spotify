...
public class controls8 {
    ...
    private Media m = new Media(getClass().getResource("/sounds/s.mp3").toString());
    ...
    private void initialize(){
        Singer singer = find();
        lname.setText(singer.getSongs().get(1).getName());
        lyear.setText("Released year: "+singer.getSongs().get(1).getYear());
        lalbum.setText("Album: "+singer.getSongs().get(1).getAlbum());
        lplays.setText("Plays: "+Integer.toString(singer.getSongs().get(1).getPlays()) + " billions");
        llyrics.setText("Lyric: "+ singer.getSongs().get(1).getLyrics());
